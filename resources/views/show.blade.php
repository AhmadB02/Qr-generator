  ...
  <div class="front-side">
    ...
    <div class="info-grid">
      ...
      <div class="emailId">
        ...
        <p class="email"> jsafawi@gmail.com
        </p>
        <p class="web">
          <strong>www</strong>.Xonboard.
          <strong>com</strong>
        </p>
      </div>
    </div>
...
<!-- <body>
  <div class="card">
    ...
    <p><span class="info-label">Name:</span> {{ $user->name }}</p>
    <p><span class="info-label">Phone:</span> {{ $user->phonenumber }}</p>
    <p><span class="info-label">Address:</span> {{ $user->address }}</p>
  </div>
</body> -->
